...
class Dimensions {
  static double fontSizeExtraSmall =
      Get.context!.width >= 1300.sp ? 14.sp : 10.sp;
  static double fontSizeSmall = Get.context!.width >= 1300.sp ? 16.sp : 12.sp;
  static double fontSizeDefault = Get.context!.width >= 1300.sp ? 18.sp : 14.sp;
  static double fontSizeLarge = Get.context!.width >= 1300.sp ? 20.sp : 16.sp;
  static double fontSizeExtraLarge =
      Get.context!.width >= 1300.sp ? 22.sp : 18.sp;
  static double fontSizeOverLarge =
      Get.context!.width >= 1300.sp ? 28.sp : 24.sp;
