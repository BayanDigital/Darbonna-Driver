        ...
        child: Scaffold(
          ...
          body: GetBuilder<HelpAndSupportController>(
            ...
            return Stack(children: [
              Column(children: [
                (helpAndSupportController.messageModel != null &&
                        helpAndSupportController.messageModel!.data != null)
                    ? helpAndSupportController.messageModel!.data!.isNotEmpty
                        ? Expanded(
                            ...
                            child: Padding(
                              ...
                              child: PaginatedListViewWidget(
                                ...
                                totalSize: helpAndSupportController
                                    .messageModel!.totalSize,
                                offset:
                                    (helpAndSupportController.messageModel !=
                                                null &&
                                            helpAndSupportController
                                                    .messageModel!.offset !=
                                                null)
                                        ? int.parse(helpAndSupportController
                                            .messageModel!.offset
                                            .toString())
                                        : null,
                                onPaginate: (int? offset) async {
                                  await helpAndSupportController
                                      .getConversation(
                                          widget.channelId, offset!);
                                },
                                itemView: ListView.builder(
                                  reverse: true,
                                  itemCount: helpAndSupportController
                                  ...
                                  itemBuilder:
                                    ...
                                    return AdminConversationBubbleWidget(
                                      message: helpAndSupportController
                                          .messageModel!.data![index],
                                      index: index,
                                      length: helpAndSupportController
                                          .messageModel!.data!.length,
                        ...
                        : const Expanded(
                            child: NoDataWidget(title: 'start_conversation'))
                    : Expanded(
                        child: Column(
                ...
                Container(
                  color: (helpAndSupportController
                              .pickedImageFile!.isNotEmpty ||
                    ...
                    helpAndSupportController.documents.isNotEmpty
                        ? SizedBox(
                            ...
                            child: ListView.builder(
                              scrollDirection: Axis.horizontal,
                              itemCount:
                                  helpAndSupportController.documents.length,
                              itemBuilder: (context, index) {
                                return Container(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        Image.asset(Images.filePreview,
                                            height: 24, width: 20),
                                        const SizedBox(
                              ...
                              child: Row(children: [
                                ...
                                Expanded(
                                  ...
                                  onChanged: (String newText) {
                                    helpAndSupportController
                                        .updateShowFaq(false, isUpdate: true);
                                  },
                                )),
                                InkWell(
                                  onTap: () =>
                                      helpAndSupportController.pickOtherFile(),
                                  child: Image.asset(
                                    height: 20,
                                    width: 20,
                                    Images.pickFile,
                                              ...
                                              if ((Get.find<SplashController>()
                                                ...
                                                if (helpAndSupportController
                                                  ...
                                                  snackBarWidget(
                                                      'write_something'.tr,
                                                      isError: true);
                                                } else if (helpAndSupportController
                      ...
                      child: Container(
                        ...
                        margin: Get.find<LocalizationController>().isLtr
                            ? EdgeInsets.only(
                                ...
                                left: Dimensions.paddingSizeSignUp)
                            : EdgeInsets.only(
                                right: Dimensions.paddingSizeSignUp,
                            ...
                            children: [
                              ...
                              Flexible(
                                child: ListView.separated(
                                  itemCount: helpAndSupportController
                                          .predefineFawModel?.data?.length ??
                                      0,
                                  shrinkWrap: true,
                                  itemBuilder: (context, index) {
                                    return InkWell(
                                      onTap: () {
                                        helpAndSupportController.sendMessage(
                                            widget.channelId,
                                            helpAndSupportController
                                                    .predefineFawModel
                                                    ?.data?[index]
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(helpAndSupportController
                                                .predefineFawModel
                                                ?.data?[index]
                                                .question ??
                                            ''),
