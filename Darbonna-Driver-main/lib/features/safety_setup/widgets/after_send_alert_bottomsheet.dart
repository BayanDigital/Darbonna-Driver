...
class AfterSendAlertBottomSheet extends StatefulWidget {
  ...
  @override
  State<AfterSendAlertBottomSheet> createState() =>
      _AfterSendAlertBottomSheetState();
}

class _AfterSendAlertBottomSheetState extends State<AfterSendAlertBottomSheet> {
  @override
  void initState() {
    Get.find<SafetyAlertController>().getSafetyAlertDetails(
        ...
        child: Padding(
          ...
          child: Column(
              ...
              children: [
                ...
                if (safetyAlertController.driverSafetyDetails?.data?.comment !=
                    null)
                  Container(
                    width: Get.width,
                ...
                Flexible(
                  child: ListView.separated(
                    itemCount: safetyAlertController
                            .driverSafetyDetails?.data?.reason?.length ??
                        0,
                    shrinkWrap: true,
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        child: Text(
                            '${safetyAlertController.driverSafetyDetails?.data?.reason?[index]}',
                            style: textSemiBold.copyWith(
                                fontSize: Dimensions.fontSizeLarge),
                            textAlign: TextAlign.center),
                      );
                ...
                Text(
                  safetyAlertController.driverSafetyDetails?.data?.status !=
                          'solved'
                ...
                if (safetyAlertController.driverSafetyDetails?.data?.status !=
                    'solved')
                  safetyAlertController.isLoading
                      ...
                      : ButtonWidget(
                          ...
                          onPressed: () =>
                              safetyAlertController.marAsSolveSafetyAlert(),
                        ),
                if (safetyAlertController.driverSafetyDetails?.data?.status !=
                    'solved')
                  safetyAlertController.isStoring
                      ...
                      : ButtonWidget(
                          ...
                          onPressed: () =>
                              safetyAlertController.resendSafetyAlert(),
                ...
                GetBuilder<SafetyAlertController>(
                  ...
                  return safetyAlertController
                                  .otherEmergencyNumberModel?.data !=
                              null &&
                          (safetyAlertController.otherEmergencyNumberModel?.data
                                  ?.isNotEmpty ??
                              false)
                      ? InkWell(
                          onTap: () {
