...
class LeaderBoardCardWidget extends StatelessWidget {
  ...
  const LeaderBoardCardWidget(
      {super.key, required this.index, required this.leaderBoard});
                ...
                child: Row(
                    ...
                    children: [
                      Expanded(
                        ...
                        Flexible(
                            child: Text(
                                ' ${leaderBoard.driver?.firstName ?? ''} ${leaderBoard.driver?.lastName ?? ''}',
                                style: textRegular.copyWith()))
                      ])),
                      Row(children: [
                        Text(
                            '${PriceConverter.convertPrice(context, double.parse(leaderBoard.income!))} /',
