                            ...
                            Row(
                                ...
                                children: [
                                  Image.asset(Images.circularClockIcon,
                                      height: 12, width: 12),
                                  Text(
                                      '${rideRequest.estimatedTime} ${'min_away'.tr}',
                                      style: textRegular.copyWith(
            ...
            endActionPane: ActionPane(
              ...
              children: [
                SlidableAction(
                  ...
                  backgroundColor:
                      Theme.of(context).colorScheme.error.withValues(alpha: .2),
                  ...
                  Container(
                    ...
                    child: Row(
                        ...
                        children: [
                          ...
                          Text(
                              '${'distance'.tr}: ${rideRequest.estimatedDistance} Km',
                              style: textRegular.copyWith(
                                color: Theme.of(context)
                                    .textTheme
                                    .bodyMedium
                                ...
                                onPressed: () {
                                  if (bidOn &&
                                    ...
                                    Get.find<RideController>()
                                      ...
                                      'rejected',
                                      rideRequest.type ?? '',
                                      rideRequest.parcelInformation?.weight ??
                                          '0',
                                      index: index ?? 0,
                                    )
                                        .then((value) {
