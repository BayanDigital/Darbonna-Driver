        ...
        body: GetBuilder<ChatController>(builder: (chatController) {
          return Column(children: [
            ...
            chatController.channelModel != null
                ? (chatController.channelModel!.data != null &&
                        chatController.channelModel!.data!.isNotEmpty)
                    ? Expanded(
                        ...
                        child: PaginatedListViewWidget(
                          ...
                          offset: chatController.channelModel != null &&
                                  chatController.channelModel!.offset != null
                              ? int.parse(chatController.channelModel!.offset
                                  .toString())
                              : 1,
                          onPaginate: (int? offset) async =>
                              await chatController.getChannelList(offset!),
                          itemView: ListView.builder(
                            itemCount:
                                chatController.channelModel!.data!.length,
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return channelUser != null
                                  ? MessageItemWidget(
                                      isRead: false,
                                      channelUsers: channelUser,
                                      unReadCount: chatController.channelModel!
                    ...
                    : const Expanded(
                        child: NoDataWidget(title: 'no_channel_found'))
