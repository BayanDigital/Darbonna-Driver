...
class _TripDetailsState extends State<TripDetails> {
  ...
  @override
  void initState() {
    Get.find<RideController>().getRideDetails(widget.tripId).then((_){
            ...
            SingleChildScrollView(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                ...
                Stack(children: [
                  ...
                  if(rideController.tripDetail?.driverSafetyAlert != null )
                    Align(
                        ...
                        child: JustTheTooltip(
                          ...
                          child: InkWell(
                            onTap: ()=> Get.bottomSheet(
                              ...
                              TripSafetySheetDetailsWidget(tripDetails: rideController.tripDetail),
