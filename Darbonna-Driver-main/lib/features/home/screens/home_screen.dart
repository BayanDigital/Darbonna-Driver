...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future loadOngoingList() async {
    ...
    // Check if ongoingRideList and parcelListModel are not null
    if (rideController.ongoingRideList == null &&
        rideController.parcelListModel?.totalSize == null) {
      // Handle the case where both are null
      return; // or show a message to the user
    }

    // Proceed with showing the BottomSheet if necessary
    if (lastRefundData != null) {
