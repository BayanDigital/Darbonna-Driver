            ...
            child: Padding(
              ...
              child: Column(
                  ...
                  children: [
                                ...
                                if (profileController.brandList.isNotEmpty)
                                  Container(
                                    ...
                                    child: DropdownButton(
                                      items: profileController.brandList
                                          .map((item) {
                              ...
                              children: [
                                ...
                                if (profileController.modelList.isNotEmpty)
                                  Container(
                                    ...
                                    child: DropdownButton(
                                      items: profileController.modelList
                                          .map((item) {
                    ...
                    if (widget.vehicleInfo == null) ...[
                      TextFieldTitleWidget(title: '${'other_documents'.tr} *'),
                      Padding(
                        ...
                        child: DottedBorder(
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              onTap: () async {
                                bool res = await profileController
                                    .pickOtherFile(false);
                                if (res) {
                                  _scrollDown();
                                }
                              ...
                              child: Builder(builder: (context) {
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    profileController.selectedFileForImport !=
                                            null
                                        ? Text(
                                            fileNamed != null
                                                ? fileNamed!.name
                        ...
                        : ButtonWidget(
                            ...
                            onPressed: () {
                              ...
                              String expireDate = profileController.dateFormat
                                  ...
                                  .toString();
                              String vinNumber =
                                  vinNumberController.text.trim();
                              String transmission =
                                  transmissionController.text.trim();
                              String fuelType =
                                  profileController.selectedFuelType;
                              if (profileController.selectedBrand!.id ==
                                  'abc') {
                                snackBarWidget('select_vehicle_brand'.tr);
                              } else if (profileController.selectedModel.id ==
                                  'abc') {
                                snackBarWidget('select_vehicle_model'.tr);
                              } else if (profileController
                                      .selectedCategory.id ==
                                  'abc') {
                                snackBarWidget('select_vehicle_category'.tr);
                              } else if (licencePlateNumber.isEmpty) {
                                snackBarWidget(
                                    'licence_plate_number_is_required'.tr);
                              } else if (expireDate.isEmpty) {
                                snackBarWidget('expire_date_is_required'.tr);
                              } else if (fuelType == 'Select Fuel type') {
                                snackBarWidget('fuel_type_is_required'.tr);
                              } else {
                                VehicleBody body = VehicleBody(
                                    ...
                                    fuelType: fuelType,
                                    driverId:
                                        profileController.profileInfo!.id ??
                                            "123456789",
                                    ownership: 'driver',
