...
class WalletController extends GetxController implements GetxService {
  ...
  Future<void> createWithdrawMethodInfo(String methodName) async {
    ...
    Get.back();
    if (response.statusCode == 200) {
      snackBarWidget('submitted_successfully'.tr, isError: false);
  ...
  Future<void> updateWithdrawMethodInfo(
    ...
    Get.back();
    if (response.statusCode == 200) {
      snackBarWidget('updated_successfully'.tr, isError: false);
      getWithdrawMethodInfoList(1);
    } else {
      ApiChecker.checkApi(response);
    }
  ...
  Future<void> deleteWithdrawMethodInfo(String methodId) async {
    ...
    Get.back();
    if (response.statusCode == 200) {
      snackBarWidget('successfully_delete_payment_method'.tr, isError: false);
      getWithdrawMethodInfoList(1);
