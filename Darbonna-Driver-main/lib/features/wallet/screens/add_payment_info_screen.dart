...
class _AddPaymentInfoScreenState extends State<AddPaymentInfoScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Scaffold(
        appBar:
            AppBarWidget(title: 'add_withdraw_method'.tr, showBackButton: true),
              ...
              return Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: Container(
                          ...
                          child: DropDownWidget<Withdraw>(
                            ...
                            hintText:
                                walletController.selectedMethod?.methodName ??
                    ...
                    if (walletController.methodList.isNotEmpty &&
                        ...
                        walletController
                            .selectedMethod!.methodFields!.isNotEmpty)
                      ListView.builder(
                        physics: const NeverScrollableScrollPhysics(),
                        shrinkWrap: true,
                        itemCount: walletController
                            .selectedMethod!.methodFields!.length,
                        itemBuilder: (context, index) {
                          String type = walletController
                              .selectedMethod!.methodFields![index].inputType!;
                              ...
                              children: [
                                Padding(
                                  padding: const EdgeInsets.symmetric(
                                      vertical: Dimensions.paddingSizeSeven),
                                  child: Text(
                                    walletController.selectedMethod
                                ...
                                TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: walletController.selectedMethod!
                  ...
                  : ButtonWidget(
                      ...
                      onPressed: () {
                        ...
                        for (int i = 0;
                            i <
                                walletController
                                    .inputFieldControllerList.length;
                            i++) {
                          if (walletController
                        ...
                        if (haveBlankTitle) {
                          snackBarWidget('please_fill_all_the_field'.tr);
                        } else if (_methodName.text.isEmpty) {
                          snackBarWidget('please_fill_all_the_field'.tr);
                        } else {
                          walletController
                              .createWithdrawMethodInfo(_methodName.text);
                        }
                      },
                    ),
            );
