...
class _PaymentInfoScreenState extends State<PaymentInfoScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      child: Scaffold(
          appBar:
              AppBarWidget(title: 'withdraw_method'.tr, showBackButton: true),
              ...
              child: Column(children: [
                walletController.isHindShow
                    ? Container(
                        ...
                        child: Row(children: [
                          ...
                          const SizedBox(width: Dimensions.paddingSizeSmall),
                          InkWell(
                            onTap: () => walletController.toggleHintTextShow(
                                false, true),
                            child: Image.asset(
                              Images.crossIcon,
                ...
                InkWell(
                  ...
                  child: Container(
                      ...
                      child: Row(
                          ...
                          children: [
                            Text(
                              'add_new_withdraw_info'.tr,
                              style: textRegular.copyWith(
                                  color: Theme.of(context).primaryColor,
                                  fontSize: Dimensions.fontSizeDefault),
                            ),
                            Image.asset(Images.outlineAddIcon,
                                height: 24, width: 24)
                          ])),
                ),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                Expanded(
                  child: walletController.withdrawMethodInfoData != null
                      ? walletController
                              .withdrawMethodInfoData!.data!.isNotEmpty
                          ? SingleChildScrollView(
                              ...
                              child: PaginatedListViewWidget(
                                ...
                                offset:
                                    (walletController.withdrawMethodInfoData !=
                                                null &&
                                            walletController
                                ...
                                onPaginate: (int? offset) async {
                                  ...
                                  await walletController
                                      .getWithdrawMethodInfoList(offset!);
                                },
                                          ...
                                          Align(
                                              ...
                                              child: PopupMenuButton(
                                                ...
                                                onSelected: (status) {
                                                  if (status == 1) {
                                                    Get.to(() =>
                                                        UpdatePaymentInfoScreen(
                                                          methods: walletController
                                                              .withdrawMethodInfoData!
                                                              .data![dataIndex],
                                                        ));
                                                  } else {
