        ...
        body: Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              GetBuilder<WalletController>(builder: (profile) {
                return ButtonWidget(
                    onPressed: () {
                      ...
                      if (accountName.isEmpty) {
                        snackBarWidget('account_name_is_required'.tr);
                      } else if (bankName.isEmpty) {
                        snackBarWidget('bank_name_is_required'.tr);
                      } else if (branchName.isEmpty) {
                        snackBarWidget('branch_name_is_required'.tr);
                      } else if (accountNumber.isEmpty) {
                        snackBarWidget('account_number_is_required'.tr);
                      } else {
                        Get.back();
                      }
                    },
