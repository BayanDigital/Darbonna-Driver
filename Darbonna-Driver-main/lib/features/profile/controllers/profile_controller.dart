...
class ProfileController extends GetxController implements GetxService {
  ...
  Future<Response> updateProfile(String firstName, String lastName,
    ...
    if (response!.statusCode == 200) {
      Get.back();
      snackBarWidget('profile_info_updated_successfully'.tr, isError: false);
      isLoading = false;
      getProfileInfo();
    ...
    if (response!.statusCode == 200) {
      ...
      getProfileInfo().then((value) {
        if (value.statusCode == 200) {
          ...
          snackBarWidget('vehicle_added_successfully'.tr, isError: false);
        }
      });
    } else {
      creating = false;
  ...
  Future<Response> updateVehicle(
    ...
    if (response!.statusCode == 200) {
      ...
      getProfileInfo().then((value) {
        if (value.statusCode == 200) {
          snackBarWidget(response.body['message'], isError: false);
        }
      });
    } else {
      creating = false;
