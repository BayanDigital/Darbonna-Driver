              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: Column(children: [
                                            Image.asset(
                                                ...
                                                scale: 3),
                                            Text('upload_identity_picture'.tr,
                                                style: textRegular.copyWith(
                                                    color: Theme.of(context)
                                                        .textTheme
                                                        .bodyMedium
                    ...
                    TextFieldTitleWidget(
                        title: 'other_documents'.tr, paddingTop: 0),
                    Padding(
                      padding: const EdgeInsets.fromLTRB(
                        Dimensions.paddingSizeDefault,
                        0,
                                      ...
                                      child: ClipRRect(
                                        ...
                                        child: SizedBox(
                                          ...
                                          child: Column(children: [
                                            ...
                                            Image.asset(Images.cloudUploadIcon,
                                                scale: 3),
                        ...
                        : ButtonWidget(
                            ...
                            onPressed: () async {
                              ...
                              if (authController.pickedProfileFile == null) {
                                snackBarWidget('profile_image_is_required'.tr);
                              } else if (email.isEmpty) {
                                snackBarWidget('email_is_required'.tr);
                                FocusScope.of(context)
                                    .requestFocus(authController.emailNode);
                              } else if (EmailChecker.isNotValid(email)) {
                                snackBarWidget('enter_valid_email_address'.tr);
                                FocusScope.of(context)
                                    .requestFocus(authController.emailNode);
                              } else if (address.isEmpty) {
                                snackBarWidget('address_is_required'.tr);
                                FocusScope.of(context)
                                ...
                                snackBarWidget('identity_image_is_required'.tr);
                              } else if (authController.identityType.isEmpty) {
                                snackBarWidget('identity_type_is_required'.tr);
                              } else {
